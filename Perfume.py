...
list_pine = ["Auntumnal", "Eldritch", "Apple Tabac", "Fanghorn", "Glühwein", "oxylus", "Bindebole", "Steading", "Boreal", "Murkwood", "Christmas Wine", "Chandlery", "Brokilän", "Icefall"]
...
list_other = ["Rise", "couer de grenade", "Love Dart", "Smokeable", "Ostara", "Baculum", "Bawd", "The Huntress", "Tramp", "Trollop", "Jezebel", "Grass", "Redcorder Music", "The One Lascivious", "Within a Daze of Passion", "Mercury Retrograde", "Yennefer"] 
